...
<div class="container">
  ...
  <br>
	  <div class="panel-body">
		...
		<a href="/parent/delete?id=${user.id?c}"><span class="glyphicon glyphicon-trash" aria-hidden="true"></a>
		</div>
		</div>
		...
		<tr>
			...
			<tr>
				...
				<td>${user.lastName!''}</td>
				<td>${user.email!''}</td>
				<td><a href="/parent/edit?id=${user.id?c}"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a>
			</tr>
