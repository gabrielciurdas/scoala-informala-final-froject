...
[/#if]
	  ...
	  <div class="col-sm-6 col-md-4">
	      <div class="caption">
	        <p><a href="/quiz/delete?quizId=${quiz.id?c}" class="btn btn-danger" role="button">Sterge</a>&nbsp; 
	        <a href="/quiz/edit?quizId=${quiz.id?c}" class="btn btn-success" role="button">Editeaza</a>
